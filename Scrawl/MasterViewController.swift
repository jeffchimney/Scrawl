...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let addButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(pushCreatorView))
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        configureCell(cell, withProject: event)
        return cell
    }
    ...
    func configureCell(_ cell: UITableViewCell, withProject project: Project) {
        cell.textLabel!.text = project.name!.description
    }
